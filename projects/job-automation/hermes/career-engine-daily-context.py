...
def main() -> int:
    ...
    context = {
        ...
        "workflow": [
            ...
            "Use the repository-owned LinkedIn-public and Freehire discovery adapters through the source CLI and configured source registry; they are source adapters, not scheduler skill attachments. Use the attached research and email skills where applicable, and do not add or edit Hermes scheduler skills during a scan.",
