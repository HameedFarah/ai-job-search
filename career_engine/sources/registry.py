...
_SOURCES: list[dict[str, Any]] = [
    {
        "id": "successfactors",
        "name": "SAP SuccessFactors RMK public careers",
        "kind": "ats_web",
        "priority": 1,
        "auth": "none",
        ...
        "blocked_reason": "",
        "base_url": "https://<tenant>/tile-search-results/",
        "docs_url": "",
        "notes": "Zero-auth SuccessFactors RMK listing plus official detail-page descriptions; pagination pattern adapted from maintained career-ops-ui integration.",
        "probe": {"verified": True, "companies": ["careers.theredsea.sa"], "verified_at": "2026-08-14"},
    },
    {
        "id": "jibeapply",
        "name": "JibeApply / iCIMS public jobs API",
        "kind": "ats_api",
        "priority": 1,
        "auth": "none",
        "posting_date": "unknown",
        ...
        "status": STATUS_ACTIVE,
        "blocked_reason": "",
        "base_url": "https://<tenant>/api/jobs",
        "docs_url": "",
        "notes": "Zero-auth Jibe/iCIMS JSON endpoint; retains full job descriptions returned by branded career sites.",
        "probe": {"verified": True, "companies": ["careers.keo.com"], "verified_at": "2026-08-14"},
    },
    {
        "id": "dar_al_riyadh",
